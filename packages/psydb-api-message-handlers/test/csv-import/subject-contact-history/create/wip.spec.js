...
describe('csv-import/subject-contact-history/create', function () {
    ...
    it('does the thing', async function () {
        var subjectType = 'child';

        var koaContext = await sendMessage({
            type: 'csv-import/subject-contact-history/create',
        ...
        console.ejson(await this.fetchAllRecords('subjectContactHistory'));
